...
const makeTrackMark = (): SVGSVGElement => {
  const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg')
  svg.classList.add('f1ti-pc__track')
  ...
  path.setAttribute(
    'd',
    'M44 151 C20 123 27 83 56 64 C84 46 101 72 84 92 C63 116 88 141 119 134 C149 127 169 105 166 79 C164 57 176 38 198 43 C220 49 225 74 211 92 C194 114 178 134 180 158 C181 171 165 179 151 168 C126 148 104 159 83 169 C67 177 53 166 44 151 Z',
  )
  ...
  start.setAttribute('d', 'M45 143 L65 162 M51 137 L71 156')
  start.setAttribute('fill', 'none')
  start.setAttribute('stroke', 'currentColor')
  start.setAttribute('stroke-width', '4')
...
export function createPersonalityCard(): PersonalityCardController {
  ...
  const showResult = (
    ...
    return new Promise<PersonalityCardAction>((resolve) => {
      ...
      const menuButton = createElement('button', 'f1ti-pc__button f1ti-pc__button--ghost', '返回比赛设置')
